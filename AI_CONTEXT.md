...
- **Công cụ lập trình**: Sử dụng **Antigravity** làm AI Coding Assistant chính. Trợ lý phải đọc file `AI_CONTEXT.md` ngay từ tin nhắn đầu tiên của mỗi phiên làm việc.
- **Git & Deployment**: Đồng bộ code thông qua **GitHub**. Antigravity tự động chịu trách nhiệm commit và push code. Tuyệt đối KHÔNG push thư mục `Models/` (AI Models).
